...
app.config['JWT_SECRET_KEY'] = 'DQMvRcKp0N' 
jwt = JWTManager(app)
    ...
    while True:
        ...
        if(id.value == 150564635253):
            if(semaforo1.state != 2):
                ...
                semaforo1.state = 0
                semaforo2.state = 0
            print({"succes": "Es tarjeta valida"})
            ...
            if(semaforo1.state != 2):
                ...
                semaforo1.state = 0
                semaforo2.state = 0
            print({"succes": "Es llavero valido"})
        else:
            print({"error": "Intento invalido de tarjeta o llavero"})
        time.sleep(1)  # Añade un retraso para evitar una ejecución excesivamente rápida
